...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between text-sm border-b border-b-gray-400'>
        <img onClick={()=>navigate('/')} className='w-20 cursor-pointer' src={assets.logo1} alt="" />
        ...
        <div className="flex items-center gap-4">
            {
                ...
                :  <button onClick={() => navigate('/login')} className='bg-primary text-white px-8 py-3 rounded-full font-light hidden md:block'>Create Appointment</button>
            }
